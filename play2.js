...
class Gato {
    ...
    constructor(nombre, edad) {
        // El objeto que voy a crear, debe contener una propiedad que se llama 'nombre' y el valor de lo que pasan por parámetro
        this.nombre = nombre;
        this.edad = edad;
    }

    // Metodos que quieras para tu Gato
...
// Puedo instanciar un segundo gato, con parametros diferentes
